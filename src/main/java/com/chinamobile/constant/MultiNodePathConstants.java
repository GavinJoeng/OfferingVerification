 ...
 */
public class MultiNodePathConstants {

    //OFFERING_ID
    //public static String OFFERING_ID = "51001800";
    public static String OFFERING_ID = "11829";
    //存儲和讀取文件夾基本路經
    public static String BASIC_PATH = "C:\\Users\\P7587\\Desktop\\testFile\\";

    public static String SINGLE_OFFERING_SQL = "";
    ...
    public static final String DISCOUNT_INTEGER_PATH = "[\"discount-calc\"][\"fixed-value\"].constant[\"constant-value\"].integer.value";

    // <!-- exponent = 0 --> 作用未知
    public static final String DISCOUNT_EXPONENT_PATH = "[\"discount-calc\"][\"fixed-value\"].constant[\"constant-value\"].exponent.value";

    // <!-- currency-measurement = 501 --> 貨幣單位
    public static final String DISCOUNT_CURRENCY_MEASUREMENT_PATH = "[\"discount-calc\"][\"fixed-value\"][\"currency-measurement\"].value";



    // <!-- integer = 0 -->，用來獲取資費信息的路經
    public static final String RECURRING_INTEGER_PATH = "[\"rate-value\"].constant[\"constant-value\"].integer.value";


    // <!-- currency-measurement = 501 --> 貨幣單位
    public static final String RECURRING_CURRENCY_MEASUREMENT_PATH = "[\"rate-value-measurement\"].value";
